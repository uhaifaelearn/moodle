...
class general_form extends moodleform {
	...
	public function definition() {
        ...
        //Input filename
        $attributes = array();
        $mform->addElement('text', 'filename', get_string('filename', 'local_exportmodsettings'), $attributes);
        $mform->setDefault('filename',  date("Y"));

        //Checkbox ifquiz
        $mform->addElement('advcheckbox', 'ifquizcron', get_string('quiz', 'local_exportmodsettings'),
                get_string('enable_disable', 'local_exportmodsettings'), array('group' => 1), array(0, 1));
        $mform->setDefault('ifquizcron',  1);

        //Checkbox ifexportsapcron
        $mform->addElement('advcheckbox', 'ifexportsapcron', get_string('export_sap', 'local_exportmodsettings'),
                get_string('enable_disable', 'local_exportmodsettings'), array('group' => 1), array(0, 1));
        ...
        $mform->addElement('advcheckbox', 'ifcreatefile', get_string('createfile', 'local_exportmodsettings'),
                get_string('enable_disable', 'local_exportmodsettings'), array('group' => 1), array(0, 1));
        $mform->setDefault('ifcreatefile',  0);

        //Checkbox ifquiz
        $mform->addElement('advcheckbox', 'ifquiz', get_string('quiz', 'local_exportmodsettings'),
                get_string('enable_disable', 'local_exportmodsettings'), array('group' => 1), array(0, 1));
        $mform->setDefault('ifquiz',  1);

        //Checkbox ifexportsap
        $mform->addElement('advcheckbox', 'ifexportsap', get_string('export_sap', 'local_exportmodsettings'),
                get_string('enable_disable', 'local_exportmodsettings'), array('group' => 1), array(0, 1));
