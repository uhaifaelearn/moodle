...
/**
 * The block_configurable_reports report showed event.
 *
...
class report_showed extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' showed the report with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('eventreportshowed', 'block_configurable_reports');
    }
