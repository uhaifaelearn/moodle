...
/**
 * The block_configurable_reports report deleted event.
 *
...
class report_deleted extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' deleted the report with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('eventreportdeleted', 'block_configurable_reports');
    }
