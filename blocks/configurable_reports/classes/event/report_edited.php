...
/**
 * The block_configurable_reports report edited event.
 *
...
class report_edited extends \core\event\base {
    ...
    public function get_description() {
        return "The user with id '$this->userid' edited the report with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('eventreportedited', 'block_configurable_reports');
    }
