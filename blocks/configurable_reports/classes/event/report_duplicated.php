...
/**
 * The block_configurable_reports report duplicated event.
 *
...
class report_duplicated extends \core\event\base {
    /**
    ...
    public function get_description() {
        return "The user with id '$this->userid' duplicated the report with id '$this->objectid' " .
    ...
    public static function get_name() {
        return get_string('eventreportduplicated', 'block_configurable_reports');
    }
