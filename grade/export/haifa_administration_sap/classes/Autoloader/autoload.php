...
namespace gradeexport_haifa_administration_sap\Autoloader;
 ...
 *          Full path to "haifa_administration_sap/classes" which is what we want "grade_export_haifa_administration" to map to.
 */
...
$loader->addNamespace('gradeexport_haifa_administration_sap', $srcBaseDirectory);
