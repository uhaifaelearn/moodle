...
namespace gradeexport_haifa_administration\Excel;
...
class HaifaExcelWorkbook extends MoodleExcelWorkbook
{
    ...
    protected function setProperties($propertiesTitle)
    {
        ...
        $properties->setCreator(get_string('properties_creator', 'gradeexport_haifa_administration'));
        $properties->setLastModifiedBy(get_string('properties_last_modified_by', 'gradeexport_haifa_administration'));
        $properties->setTitle($propertiesTitle);
        $properties->setCompany(get_string('properties_company', 'gradeexport_haifa_administration'));
