...
/**
 * Strings for component 'gradeexport_haifa_administration', language 'en', branch 'MOODLE_29_STABLE'
 *
 * @package gradeexport_haifa_administration
 */

$string['pluginname']                   = 'אוניברסיטת חיפה - מינהל תלמידים';
$string['timeexported']                 = 'האחרון שהורד מקורס זה';
$string['haifa_administration:view']    = 'השתמש ביצוא ציונים עבור מינהל תלמידים';
$string['haifa_administration:publish'] = 'פרסם יצוא ציונים עבור מינהל תלמידים';
...
$string['grade_option']                 = 'בחרו מועד א / ב / מיוחד / עבודה מסכמת';
